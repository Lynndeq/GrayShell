...
powershell /c write-host -back cyan -fore white 1.0-RELEASE
echo.
goto cmd
:curdir
cls
...
powershell /c write-host -back cyan -fore white 1.0
echo.
powershell /c write-host -fore darkred Enter the command:
set /p suinput="# "
if %suinput% == xmd goto suxmd
...
if %xmdinput% == enablechatclear goto clearcmd
if %xmdinput% == remsh goto remsh
cmd /c %xmdinput%
goto xmd9
:suxmd9
...
if %xmdinput% == enablechatclear goto suclearcmd
if %xmdinput% == remsh goto remsh
sudo cmd /c %xmdinput%
goto xmd9
:rtrn9
